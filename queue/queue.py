...
# 3. When using an array while implementing a Queue the first element must be 
# removed and/or a new element must be added as the last element.

# When using a linked list while implementing a Queue an element must be added
# to the tail which changes the address of the last element and of the tail.

# When dequeueing the head must be removed, then the addresses can be 
# reallocated to each and every element.
